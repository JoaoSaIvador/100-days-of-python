...
crossroad = input("You're at a bifurcation in the forest. Would you like to go 'left' or 'right'?\n").lower()
...
if crossroad == "left":
    ...
    if river == "b" or river == "keep moving":
        ...
        door = input("You are now deep into the forest and see 3 doors. Which will you choose? 'Red', 'Blue', 'Yellow' or 'Keep moving'?\n").lower()
        if door == "yellow":
        ...
        print("Oh no, you didn't see the crocodile waiting beneath the surface. GAME OVER!")
else:
